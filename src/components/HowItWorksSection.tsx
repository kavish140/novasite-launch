...
const steps = [
  {
    number: "01",
    title: "Get in Touch",
    description: "Call us or send an email with your requirements. We'll discuss your vision, goals, and timeline.",
  },
  {
    number: "02",
    title: "We Design & Build",
    description: "Our team crafts a custom website tailored to your brand — stunning visuals, fast performance, fully responsive.",
  },
  {
    number: "03",
    title: "Launch & Support",
    description: "We deploy your site and provide ongoing support. Your website goes live and starts growing your business.",
  },
];
