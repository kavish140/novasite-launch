...
export default function Bhandup() {
  return (
    <LocationPageTemplate
      locationName="Bhandup"
      subTitle="Professional web design and development services for businesses along the LBS Marg corridor in Bhandup, Mumbai."
      description="SiteNova delivers fast, mobile-optimized websites for businesses in Bhandup — from retail shops along LBS Marg to clinics and coaching centres near Bhandup station. We understand the local market dynamics that drive foot traffic and online enquiries in this growing eastern Mumbai suburb."
