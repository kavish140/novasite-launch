...
export default function Dadar() {
  return (
    <LocationPageTemplate
      locationName="Dadar"
      subTitle="Premium web design for businesses in Dadar — central Mumbai's cultural and commercial heart, connecting the Western and Central railway lines."
      description="SiteNova provides top-tier website development for businesses in Dadar, one of Mumbai's most iconic and centrally located suburbs. Whether you're a boutique near the famous Dadar flower market, a restaurant along Shivaji Park, or a professional service firm in the TT Circle area, we build websites that match the energy and ambition of this legendary neighbourhood."
