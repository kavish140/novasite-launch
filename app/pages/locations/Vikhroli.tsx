...
export default function Vikhroli() {
  return (
    <LocationPageTemplate
      locationName="Vikhroli"
      subTitle="Modern web design services for businesses in Vikhroli — home to the iconic Godrej campus, IT parks, and a growing startup ecosystem."
      description="SiteNova crafts professional, high-performance websites for companies based in and around Vikhroli's unique industrial-residential landscape. From IT firms in the Godrej campus to local retailers and service providers along the Eastern Express Highway, we deliver websites engineered for lead generation and local visibility."
