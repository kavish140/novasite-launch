...
export default function Bandra() {
  return (
    <LocationPageTemplate
      locationName="Bandra"
      subTitle="Premium web design and local SEO for businesses in Bandra — Mumbai's vibrant hub for startups, cafes, and creative agencies."
      description="SiteNova partners with businesses across Bandra to build stunning, high-converting websites. Whether you run a boutique in Linking Road, a cafe in Bandra Reclamation, or a startup in BKC, we understand Bandra's unique aesthetic and highly competitive market."
