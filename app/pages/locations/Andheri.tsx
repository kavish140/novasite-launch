...
export default function Andheri() {
  return (
    <LocationPageTemplate
      ...
      subTitle="Results-driven web design and SEO for businesses in Andheri — Mumbai's largest commercial suburb, home to MIDC, SEEPZ, and Lokhandwala."
      description="SiteNova designs high-converting websites for the diverse business landscape of Andheri. From export firms in SEEPZ and tech companies in MIDC Andheri East to restaurants and retail brands along Lokhandwala and Versova, we build websites that reflect the scale and energy of Mumbai's most commercially active suburb."
