...
export default function Nahur() {
  return (
    <LocationPageTemplate
      locationName="Nahur"
      subTitle="Affordable, high-quality web design for small businesses and clinics in Nahur — a growing residential pocket between Bhandup and Mulund."
      description="SiteNova helps Nahur's growing community of small businesses, medical practitioners, and local service providers establish a strong online presence. From newly opened shops near Nahur station to dental clinics and tuition centres in Nahur East, we build websites that bring neighbourhood customers straight to your door."
