...
export default function Thane() {
  return (
    <LocationPageTemplate
      locationName="Thane"
      subTitle="Full-service web development and local SEO for businesses in Thane — Mumbai's fast-growing satellite city with booming IT parks and commercial corridors."
      description="SiteNova partners with businesses across Thane to build stunning, performance-driven websites. From established firms in Wagle Estate to new ventures along Ghodbunder Road, we understand Thane's unique identity as a self-contained city with its own thriving economy, lakes, and rapidly expanding tech ecosystem."
