...
export default function AdLeadsTab({ allAdLeads, loading, onUpdateStatus }: AdLeadsTabProps) {
  ...
  return (
    <motion.div className="space-y-6" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      ...
      <div className="flex items-center gap-3 p-4 rounded-xl bg-purple-500/10 border border-purple-500/20 text-sm text-purple-400">
        ...
        <span>
          These leads came from your paid ad campaigns via{" "}
          <strong className="text-purple-300">/lp/web-design</strong>.
        </span>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="bg-card/40 border border-purple-500/10 rounded-xl overflow-hidden shadow-sm">
          {loading ? (
            ...
            <EmptyState icon={Megaphone} title="No pending ad leads!" description="You're all caught up on follow-ups." />
          ) : (
            <>
