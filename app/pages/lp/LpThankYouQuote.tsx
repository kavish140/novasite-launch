...
export default function LpThankYouQuote() {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hi Kavish, I just submitted a quote request on SiteNova for a ${projectType}. My name is ${name}. Looking forward to hearing from you!`
  );
          ...
          >
            ...
            <div className="max-w-xl mx-auto space-y-2">
              ...
              <p className="text-muted-foreground text-xs">
                We typically respond within 24 hours. For the fastest response,
