...
import { PHONE_TEL_LINK } from "@/lib/constants";

export default function LpThankYouAudit() {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hi Kavish, I just requested a free website audit on SiteNova. My name is ${name}. Looking forward to your report!`
  );
          ...
          >
            ...
            <div className="max-w-xl mx-auto space-y-2">
              ...
              <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
                ...
                Our team will review your site and send a detailed report to{" "}
                <span className="text-foreground font-semibold">{email}</span>{" "}
                within 24–48 hours.
              </p>
              <p className="text-muted-foreground text-xs">
                For the fastest update, reach us directly via the options below:
              </p>
            </div>
