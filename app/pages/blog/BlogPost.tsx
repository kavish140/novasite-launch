        ...
        <article>
          ...
          <div 
            ...
            dangerouslySetInnerHTML={{ __html: sanitizeHtml(post.content, {
              allowedTags: sanitizeHtml.defaults.allowedTags.concat(['img', 'iframe', 'video', 'source', 'picture', 'figure', 'figcaption', 'details', 'summary', 'mark', 'del', 'ins', 'sub', 'sup']),
              allowedAttributes: {
          ...
          <div className="not-prose mt-10 flex items-start gap-4 rounded-2xl border border-border/60 bg-card/40 p-6">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5 mb-2">Founder & Lead Developer at SiteNova · Web Designer in Mulund, Mumbai</p>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Kavish builds fast, SEO-ready websites for businesses across Mumbai. He writes about web design, local SEO, and digital growth for Indian small businesses.
              </p>
            </div>
          </div>
        </article>
