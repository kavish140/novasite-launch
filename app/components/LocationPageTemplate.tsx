        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="space-y-4 max-w-3xl">
            {[
              ...
              {
                q: `Is a custom website better than WordPress for a ${locationName} business?`,
                a: `It depends on your goals. WordPress is great for simple blogs and content sites. But if you want a faster, more secure, and fully unique website that ranks well on Google, a custom-built site (like the ones SiteNova builds) consistently outperforms WordPress templates — especially for local search in ${locationName}. We'll recommend the right option for your budget and goals in your first consultation.`
              },
            ].map((item, idx) => (
