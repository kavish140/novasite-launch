...
type Module = typeof import("../portfolio.jupiter-fast-finance.js")

type Info = GetInfo<{
  file: "routes/portfolio.jupiter-fast-finance.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../portfolio.jupiter-fast-finance.js");
}];
